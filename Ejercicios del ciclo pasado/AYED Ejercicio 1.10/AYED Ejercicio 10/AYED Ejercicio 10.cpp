// AYED Ejercicio 10.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
/*
...
int main()
{
    int dia, mes, anio, dia1, mes1, anio1, dia2, mes2, anio2; //Variables de tipo entero que almacenan las fechas
    int contadorDias1 = 0, contadorDias2 = 0; //Variables de tipo entero que almacenan cuantos dias de diferencia hay entre la fecha actual, inicializadas en cero
    unsigned int aux; //Variable de tipo entero no signado que almacena una copia de los años
